...
public class LogInPageController extends CreateAccountController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        File file11 = new File("images\\wallpapers.png");
        background.setImage(new Image(file11.toURI().toString()));
